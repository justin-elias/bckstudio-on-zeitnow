    ...
    if (clayClass.disableBookingButton || !clayClass.classLink) {
      if (deviceSize === "small") {
        return (
          ...
          >
            Call to be placed on our Waitlist!
          </Typography>
        );
      }
      return (
        <Typography align={"left"} className={classNames(classes.classHeaders)}>
          Call to be placed on our Waitlist!
        </Typography>
      );
    }
        ...
        <React.Fragment key={index}>
          ...
          <GridContainer className={classes.container} alignItems={"center"}>
            ...
            <Hidden smDown>
              <Image
                src={vCone}
                alt={"Vertical Cones Divider"}
                width={"25px"}
                height={"320px"}
                className={classes.verticalCones}
              />
            </Hidden>
            <Hidden mdUp>
              <div className={classes.horizontalCones}>
                <Image
                  src={hCone}
                  alt={"Horizontal Cones Divider"}
                  width={"160px"}
                  height={"11px"}
                  className={classes.horizontalCones}
                />
              </div>{" "}
            </Hidden>
