...
export async function getStaticProps(context) {
  ...
  const membershipsQueryResult = await queryCMS(
    membershipsQuery,
    token,
    endPoint,
  );
          ...
          <BrandedHeader>
            ...
            <div className={classes.textBody}>
              <Typography variant={"body1"} component={"p"} align={"center"}>
                Thank you for your interest in joining our clay family.
                Memberships keep us open and allow members access to the studio
                and equipment up to 24/7. During regular business hours, Ashleah
                and Heather are available to meet the individualized needs of
                our members. Read the membership descriptions below and find the
